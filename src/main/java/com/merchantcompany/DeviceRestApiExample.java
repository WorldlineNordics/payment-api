...
public class DeviceRestApiExample {
    ...
    public static void main(String[] args) {
        ...
        PaymentHandler paymentHandler = new PaymentHandler(
                ...
                "https://worldline-endpoint:1234/paymentOptions");
        ...
        System.out.println(paymentHandler.createGetPaymentAPIRequest(new PaymentOptionsRequest("3456789", 1640156216L, "pos")));
