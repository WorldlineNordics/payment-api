...
public class ShorterResponse_V6Test {
	...
	@Test
	public void ShorterResonseDecryptV6Test() {
		String DECRYPTED = "ACA=PP_1657636376606;ACB=2;ACC=debit;";
		...
		String decr = decryptor.decodeWithBase64(ENCRYPTED);
